...
function howManyMovies(moviesArray) {
    ...
    const SPdrama = moviesArray.filter((movies) => {
        const SPmovies = movies.director === 'Steven Spielberg';

        const dramaMovies = movies.genre.indexOf ('Drama') >= 0;

        return SPmovies && dramaMovies;
    })
